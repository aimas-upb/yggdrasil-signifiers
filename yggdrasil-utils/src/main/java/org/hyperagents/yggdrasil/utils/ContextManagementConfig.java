...
public interface ContextManagementConfig extends Shareable {
     ...
     * 
     */
    List<ContextStream> getContextStreams();
     ...
     */
    List<ContextDomain> getContextDomains();
     ...
     */
    Optional<ContextDomain> getContextDomainByURI(String domainURI);
     ...
     */
    Optional<ContextStream> getContextStreamByURI(String streamURI);
}
