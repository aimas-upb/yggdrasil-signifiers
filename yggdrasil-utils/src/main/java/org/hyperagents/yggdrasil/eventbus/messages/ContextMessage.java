...
public sealed interface ContextMessage
    permits ContextMessage.ValidateContextBasedAccess,
            ContextMessage.ValidateWorkspaceContextBasedAccess,
            ContextMessage.GetStaticContext,
            ContextMessage.GetProfiledContext,
            ContextMessage.ContextStreamUpdate,
            ContextMessage.VerifyContextStreamSubscription {
  ...
  /**
   * A record representing a request to validate the current context of an accessRequester against the context-based conditions
   * that authorize the access to the accessedWorkspace.
   * 
   * <p> The acceeRequesterURI is the URI of the entity that requests the access to the accessedWorkspace.
   * <p> The accessedWorkspaceURI is the URI of the workspace that is requested to be accessed.
   * 
   * @param accessRequesterURI The URI of the entity that requests the access to the accessedWorkspace.
   * @param accessedWorkspaceURI The URI of the workspace that is requested to be accessed.
   */
  record ValidateWorkspaceContextBasedAccess(String accessRequesterURI, String accessedWorkspaceURI) implements ContextMessage {}
